...
function POSTopbar({
  ...
  return (
    <header className="w-full border-slate-200/70 px-3 py-3 sm:px-4 sm:py-3.5 mt-6">
      <div className="space-y-3">
        ...
        {/* <div className="flex items-center justify-end gap-2.5">
          <button
            className="inline-flex items-center gap-1.5 rounded-md border border-[#4B2C8D] bg-[#2A1656] px-3 py-1.5 text-xs font-semibold text-white transition hover:bg-[#3c236f]"
